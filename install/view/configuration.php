<form name="config-form" id="config-form" action="do_install.php" method="post">
  ...
  <div class="section clearfix">
    <p>1. Por favor, insira as informa&ccedil;&otilde;es da sua conex&atilde;o de <strong>banco de dados</strong>.</p>
    <hr />
    <div>
      ...
      <div class="form-group clearfix">
        <label for="dbuser" class=" col-md-3">Usu&aacute;rio</label>
        <div class=" col-md-9">
          <input type="text" value="" id="dbuser" name="dbuser" class="form-control" autocomplete="off"
          placeholder="Nome de usu&aacute;rio do banco de dados" />
        </div>
      </div>
      <div class="form-group clearfix">
        ...
        <div class=" col-md-9">
          ...
          autocomplete="off" placeholder="Senha do usu&aacute;rio do banco de dados" />
        </div>
      </div>
      <div class="form-group clearfix">
  ...
  <div class="section clearfix">
    <p>2. Por favor, insira as informa&ccedil;&otilde;es para sua conta de <strong>administrador</strong>.</p>
    <hr />
    <div>
      <div class="form-group clearfix">
