...
(2, 'app_name', 'Arbidsofts'),
(3, 'app_theme', 'default'),
(4, 'per_page', '100'),
(5, 'os_notification', 'cliente'),
(6, 'control_estoque', '1'),
(7, 'notifica_whats', 'Prezado(a), {CLIENTE_NOME} a O.S. de nº {NUMERO_OS} teve o status alterado para :{STATUS_OS} segue a descrição {DESCRI_PRODUTOS} com valor total de {VALOR_OS}!\r\n Para mais informações entre em contato conosco.\r\n Atenciosamente, {EMITENTE} {TELEFONE_EMITENTE}.'),
(8, 'control_baixa', '0'),
(9, 'control_editos', '1'),
...
(1, 'admin_name', '', '', '06541-038', 'Av. Yojiro Takaoka', '4384', 'Alphaville', 'Santana de Parnaíba', 'SP', 'admin_email', 'admin_password', '11 4272-0995', '11 96022-6175', 1, 'admin_created_at', 1, '2102-01-01');
