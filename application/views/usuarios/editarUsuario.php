...
<div class="row-fluid" style="margin-top:0">
    ...
    echo '<div class="alert alert-danger">' . $custom_error . '</div>';
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="cpfUser" type="text" name="cpf" value="<?php echo $result->cpf; ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="senha" type="password" name="senha" value="" placeholder="N&atilde;o preencha se n&atilde;o quiser alterar." />
                            <i class="icon-exclamation-sign tip-top" title="Se n&atilde;o quiser alterar a senha, n&atilde;o preencha esse campo."></i>
                        </div>
                    </div>
    ...
    $inativo = 'selected';
                    ...
                    <div class="control-group">
                        <label class="control-label">Permiss&otilde;es<span class="required">*</span></label>
                        <div class="controls">
