        ...
        <div class="row-fluid">
            <div class="span12">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th width="130" align="center" style="font-size: 15px">Pre&ccedil;o Compra</th>
                                    <th width="130" align="center" style="font-size: 15px">Pre&ccedil;o Venda</th>
                ...
                <h5 style="text-align: right; font-size: 0.8em; padding: 5px;">
                    Data do Relat&oacute;rio: <?php echo date('d/m/Y'); ?>
                </h5>
            </div>
        </div>
    </div>
