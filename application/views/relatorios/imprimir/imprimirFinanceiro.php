            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-title">
                        <h4 style="text-align: center">Relat&oacute;rio Financeiro</h4>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 1.2em; padding: 5px;width: 20%;">Situa&ccedil;&atilde;o</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                ...
                <h5 style="text-align: right">Data do Relat&oacute;rio:
                    <?php echo date('d/m/Y'); ?>
                </h5>
