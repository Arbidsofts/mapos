    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding tab-content">
                        <table width="100%" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th width="70" align="center" style="font-size: 12px">O.S.</th>
                                    ...
                                    <th width="400" align="center" style="font-size: 12px">DESCRI&Ccedil;&Atilde;O</th>
                                    <th width="140" align="center" style="font-size: 12px">TOTAL PRODUTOS</th>
                                    <th width="140" align="center" style="font-size: 12px">TOTAL SERVI&Ccedil;OS</th>
                ...
                <h5 style="text-align: right; font-size: 0.8em; padding: 5px;">Data do Relat&oacute;rio: <?php echo date('d/m/Y'); ?>
            </div>
        </div>
    </div>
</body>
