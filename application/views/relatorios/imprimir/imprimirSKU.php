    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 1.2em; padding: 5px;">Descri&ccedil;&atilde;o Produto</th>
                                    ...
                                    <th style="font-size: 1.2em; padding: 5px;">Pre&ccedil;o Unitário</th>
                                    <th style="font-size: 1.2em; padding: 5px;">Pre&ccedil;o Total</th>
                ...
                <h5 style="text-align: right">Data do Relat&oacute;rio: <?php echo date('d/m/Y'); ?>
                </h5>
            </div>
        </div>
    </div>
