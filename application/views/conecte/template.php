...
<head>
    <title>&Aacute;rea do Cliente - <?php echo $this->config->item('app_name') ?></title>
    <meta charset="UTF-8"/>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon fas fa-bars"></i> Menu</a>
    <ul>
        ...
        <li class="<?php if (isset($menuOs)) {echo 'active';}; ?>">
		  <a href="<?php echo base_url() ?>index.php/mine/os"><i class="icon fas fa-diagnoses"></i> <span>Ordens de Servi&ccedil;o</span></a></li>
        ...
        <li class="<?php if (isset($menuCobrancas)) {echo 'active';}; ?>">
		  <a href="<?php echo base_url() ?>index.php/mine/cobrancas"><i class="icon fas fa-barcode"></i> <span>Cobran&ccedil;as</span></a></li-->
...
<div class="row-fluid">
    <div id="footer" class="span12">
        <?= date('Y') ?> &copy;
        <?php echo $this->config->item('app_name'); ?> - Vers&atilde;o:
