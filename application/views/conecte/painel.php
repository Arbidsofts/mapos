<div class="quick-actions_homepage">
    <ul class="quick-actions">
        <li class="bg_lo span3"> <a href="<?php echo base_url() ?>index.php/mine/os"> <i class="fas fa-diagnoses" style="font-size:36px"></i>
                <div>Ordens de Servi&ccedil;o</div>
            </a></li>
        <!--li class="bg_ls span3"> <a href="<?php echo base_url() ?>index.php/mine/compras"><i class="fas fa-shopping-cart" style="font-size:36px"></i>
                <div>Compras</div>
            </a></li-->
        <li class="bg_ls span3"> <a href="<?php echo base_url() ?>index.php/mine/conta"><i class="fas fa-user"  style="font-size:36px"></i>
                <div>Minha Conta</div>
            </a></li>
    </ul>
</div>
...
<div class="span12" style="margin-left: 0">
    <div class="widget-box">
        <div class="widget-title"><span class="icon"><i class="fas fa-signal"></i></span>
            <h5>&Uacute;ltimas Ordens de Servi&ccedil;o</h5>
        </div>
            ...
            <table id="tabela" class="table table-bordered">
                ...
                <tbody>
                    ...
                    if ($os != null) {
                        ...
                        echo '<tr><td colspan="3">Nenhum ordem de servi&ccedil;o encontrada.</td></tr>';
                    }
                    ?>
                </tbody>
            </table>
