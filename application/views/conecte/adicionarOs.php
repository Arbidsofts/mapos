                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%;">
                                        <div class="span12 alert alert-info">
                                            <h5 class="text-center">Preencha o campo abaixo detalhando o que voc&ecirc; precisa.</h5>
											<!-- Campos com asterisco são obrigatórios. (Adicionar essa frase quando necessário) -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span12">
                                            <label for="descricaoProduto">Descri&ccedil;&atilde;o do Defeito*</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#formOs").validate({
            ...
            messages: {
                descricaoProduto: {
                    required: 'O campo descri&ccedil;&atilde;o da O.S. &eacute; obrigat&oacute;rio.'
                }
            },
