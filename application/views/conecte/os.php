...
if (!$this->session->userdata('cadastra_os')) { ?>
    <div class="span12" style="margin-left: 0">
        <div class="span3">
            <a href="<?php echo base_url(); ?>index.php/mine/adicionarOs" class="btn btn-success span12"><i class="fas fa-plus"></i> Adicionar O.S.</a>
        </div>
    </div>
<?php
}
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
                ...
                <table id="tabela" class="table table-bordered ">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="6">Nenhuma O.S. cadastrada.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<?php
    ...
    <div class="span12" style="margin-left: 0">
        ...
        if ($r->status == "Aberto") {
            ...
            $status = '<span class="label label-info">Or&ccedil;amento</span>';
            ...
            $status = '<span class="label">Negocia&ccedil;&atilde;o / Inadimplente</span>';
        } else {
