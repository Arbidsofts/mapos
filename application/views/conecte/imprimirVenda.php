...
<head>
    <title>Balc&atilde;o_Digital_<?php echo $result->idVendas ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                            ...
                            <tbody>
                                ...
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: center">#Venda: <span><?php echo $result->idVendas ?></span></br> </br> <span>Emiss&atilde;o: <?php echo date('d/m/Y'); ?></span></td>
                                    </tr>
                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <span>E-mail: <?php echo $result->email_user ?></span>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
