                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        <td colspan="3" class="alert">Os dados do emitente n&atilde;o foram configurados.</td>
                                    </tr>
                                <?php
                                } else { ?>
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: center">#Protocolo: <span>
                                                <?php echo $result->idOs ?></span></br> </br> <span>Emiss&atilde;o:
                            ...
                            <table class="table table-condensed">
                                <tbody>
                                    ...
                                    <?php if ($result->laudoTecnico != null) { ?>
                                        <tr>
                                            <td>
                                                <strong>Laudo T&eacute;cnico</strong> <br>
                            ...
                            <table class="table table-condensed" id="tblProdutos">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: large">Pre&ccedil;o unit.</th>
