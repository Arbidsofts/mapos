...
<body>
  ...
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      <li class=""><a title="&Aacute;rea do Cliente" href="<?= site_url(); ?>/mine" target="_blank"><i class="fas fa-eye"></i> <span class="text">&Aacute;rea do Cliente</span></a></li>
      <!--li class="pull-right"><a href=""><i class="fas fa-asterisk"></i> <span class="text">Vers&atilde;o:
