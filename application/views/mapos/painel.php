            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vServico')) : ?>
                <li class="bg_ly">
                    <a href="<?= base_url() ?>index.php/servicos"> <i class="fas fa-wrench" style="font-size:36px"></i>
                        <div>Servi&ccedil;os <span class="badge badge-light">F3</span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                <li class="bg_lo">
                    <a href="<?= base_url() ?>index.php/os"> <i class="fas fa-diagnoses" style="font-size:36px"></i>
                        <div>O.S. <span class="badge badge-light">F4</span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')) : ?>
                <li class="bg_lv">
                    <a href="<?= base_url() ?>index.php/garantias"><i class="fas fa-book" style="font-size:36px"></i>
                        <div>Garantias <span class="badge badge-light">F7</span></div>
                    </a>
                </li>
            <?php endif ?>
        </ul>
...
<div class="row-fluid" style="margin-top: 0">
                    ...
                    <div id='source-calendar'>
                        <form method="post">
                            <select class="span12" name="statusOsGet" id="statusOsGet" value="">
								...
								<option value="Aguardando Pe&ccedil;as">Aguardando Pe&ccedil;as</option>
								<option value="Aprovado">Aprovado</option>
								<option value="Cancelado">Cancelado</option>
								<option value="Em Andamento">Em Andamento</option>
								<option value="Faturado">Faturado</option>
								<option value="Finalizado">Finalizado</option>
								<option value="Negocia&ccedil;&atilde;o">Negocia&ccedil;&atilde;o</option>
                                <option value="Or&ccedil;amento">Or&ccedil;amento</option>
                            </select>
    ...
    <div class="span12" style="margin-left: 0">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Produtos Com Estoque M&iacute;nimo</h5>
            </div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>C&oacute;d. Item</th>
                            <th>Produto</th>
    ...
    <div class="span12" style="margin-left: 0">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Ordens de Servi&ccedil;o Em Aberto</h5>
            </div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
    ...
    echo "";
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="3">Nenhuma O.S. em aberto.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box">
        <div class="widget-title">
            <span class="icon"><i class="fas fa-diagnoses"></i></span>
            <h5>Ordens de Servi&ccedil;o Aguardando Pe&ccedil;as</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="3">Nenhuma O.S. aguardando pe&ccedil;as.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box">
        <div class="widget-title">
            <span class="icon"><i class="fas fa-diagnoses"></i></span>
            <h5>Ordens de Servi&ccedil;o Em Andamento</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="3">Nenhuma O.S. em andamento.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) : ?>
            <div class="row-fluid" style="margin-top: 0">
                ...
                <div class="span4">
                    ...
                    <div class="widget-box">
                        <div class="widget-title"><span class="icon"><i class="fas fa-hand-holding-usd"></i></span>
                            <h5>Estat&iacute;sticas financeiras - Realizado</h5>
                        </div>
                        <div class="widget-content">
                            <div class="row-fluid">
                                <div class="span12">
                ...
                <div class="span4">
                    ...
                    <div class="widget-box">
                        <div class="widget-title"><span class="icon"><i class="fas fa-hand-holding-usd"></i></span>
                            <h5>Estat&iacute;sticas financeiras - Pendente</h5>
                        </div>
                        <div class="widget-content">
                            <div class="row-fluid">
                                <div class="span12">
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title"><span class="icon"><i class="fas fa-diagnoses"></i></span>
                    <h5>Estat&iacute;sticas de O.S.</h5>
                </div>
                <div class="widget-content">
                    <div class="row-fluid">
                        <div class="span12">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="fas fa-signal"></i></span>
                <h5>Estat&iacute;sticas do Sistema</h5>
            </div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="site-stats">
                            ...
                            <li class="bg_lh"><i class="fas fa-diagnoses"></i> <strong>
                                    <?= $this->db->count_all('os'); ?></strong> <small>Ordens de Servi&ccedil;o</small></li>
                            <li class="bg_lh"><i class="fas fa-wrench"></i> <strong>
                                    <?= $this->db->count_all('servicos'); ?></strong> <small>Servi&ccedil;os</small></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div id="calendarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Status O.S. Detalhada</h3>
    </div>
    <div class="modal-body">
        <div class="span12" id="divFormStatusOS" style="margin-left: 0"></div>
        <h4><b>O.S.:</b> <span id="modalId" class="modal-id"></span></h4>
    ...
    <div class="modal-footer">
        ...
        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
            echo '<a id="modalIdEditar" style="margin-right: 1%" href="" class="btn btn-info tip-top" title="Editar O.S."><i class="fas fa-edit"></i></a>';
        }
        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'dOs')) {
            echo '<a id="linkExcluir" href="#modal-excluir-os" role="button" data-toggle="modal" os="" class="btn btn-danger tip-top" title="Excluir O.S."><i class="fas fa-trash-alt"></i></a>  ';
        }
        ?>
    </div>
</div>
...
<div id="modal-excluir-os" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/os/excluir" method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h5 id="myModalLabel">Excluir O.S.</h5>
        </div>
        <div class="modal-body">
    ...
    $(document).ready(function() {
        ...
        var srcCalendar = new FullCalendar.Calendar(srcCalendarEl, {
            ...
            events: {
                ...
                failure: function() {
                    alert('Falha ao buscar O.S. de calendário!');
                },
            },
