...
<div id="loginbox">
            ...
            <div class="control-group">
                <div class="controls">
                    <div class="main_input_box">
                        <span class="add-on bg_lg"><i class="fas fa-user"></i></span><input id="email" name="email" type="text" placeholder="E-mail" />
                    </div>
                </div>
            </div>
            <div class="control-group">
    ...
    <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h4 id="myModalLabel">Balc&atilde;o Digital</h4>
        </div>
        <div class="modal-body">
            <h5 style="text-align: center" id="message">Os dados de acesso est&atilde;o incorretos, por favor tente novamente!</h5>
        </div>
            ...
            $("#formLogin").validate({
                ...
                messages: {
                    email: {
                        ...
                        email: 'Insira e-mail v&aacute;lido'
                    },
                    senha: {
                        required: 'Campo Requerido.'
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.result == true) {
                                ...
                                $('#message').text(data.message || 'Os dados de acesso est&atilde;o incorretos, por favor tente novamente!');
