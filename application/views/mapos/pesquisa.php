        ...
        <div class="widget-box" style="min-height: 200px">
            ...
            <div class="widget-content nopadding tab-content">
                <table class="table table-bordered ">
                    ...
                    <?php
                    if ($servicos == null) {
                        echo '<tr><td colspan="4">Nenhum servi&ccedil;o foi encontrado.</td></tr>';
                    }
                    foreach ($servicos as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eServico')) {
                            echo '<a href="' . base_url() . 'index.php/servicos/editar/' . $r->idServicos . '" class="btn btn-info tip-top" title="Editar Servi&ccedil;o"><i class="fas fa-edit"></i></a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                    }
        ...
        <div class="widget-box" style="min-height: 200px">
            ...
            <div class="widget-content nopadding tab-content">
                <table class="table table-bordered ">
                    ...
                    <?php
                    if ($os == null) {
                        echo '<tr><td colspan="4">Nenhuma O.S. foi encontrada.</td></tr>';
                    }
                    foreach ($os as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                            echo '<a href="' . base_url() . 'index.php/os/editar/' . $r->idOs . '" class="btn btn-info tip-top" title="Editar O.S."><i class="fas fa-edit"></i></a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                    }
