        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content ">
                    <div class="alert alert-danger">Nenhum dado foi cadastrado at&eacute; o momento. Essas informa&ccedil;&otilde;es
                        estar&atilde;o dispon&iacute;veis na tela de impress&atilde;o de O.S.</div>
        ...
        <form action="<?= site_url('mapos/cadastrarEmitente'); ?>" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="control-group">
                    <label for="nome" class="control-label">Raz&atilde;o Social<span class="required">*</span></label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label for="descricao" class="control-label"><span class="required">N&uacute;mero*</span></label>
                    <div class="controls">
...
<?php
    ...
    <div class="row-fluid" style="margin-top:0">
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content ">
                    <div class="alert alert-info">Os dados abaixo ser&atilde;o utilizados no cabe&ccedil;alho das telas de impress&atilde;o.</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> <span style="font-size: 20px; ">
                                        ...
                                        <?= $dados[0]->cnpj; ?> </br>
                                        <?= $dados[0]->rua . ', Nº ' . $dados[0]->numero . ' - ' . $dados[0]->bairro; ?><br />
                                        <?= $dados[0]->cidade . ' - ' . $dados[0]->uf . ' - ' . $dados[0]->cep; ?>
                                    </span> </br>
                                    <span> <?= $dados[0]->email . ' - ' . $dados[0]->telefone; ?></span></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div id="modalLogo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action="<?= site_url('mapos/editarLogo'); ?>" id="formLogo" enctype="multipart/form-data" method="post" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="span12 alert alert-info">Selecione uma nova imagem da logotipo. Tamanho indicado (300 x 130 px).</div>
                <div class="control-group">
                    <label for="logo" class="control-label"><span class="required">Logotipo*</span></label>
                    <div class="controls">
                        <input type="file" name="userfile" value="" />
