<div class="accordion" id="collapse-group">
        ...
        <div class="accordion-heading">
            <div class="widget-title">
                <a data-parent="#collapse-group" href="#collapseGOne" data-toggle="collapse">
                    ...
                    <h5>Detalhes da Cobran&ccedil;a</h5>
                </a>
            </div>
        </div>
            ...
            <div class="widget-content">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align: right"><strong>Valor da cobran&ccedil;a</strong></td>
                            <td>R$
    ...
    $result->status
                        ...
                        <tr>
                            <td style="text-align: right"><strong>Expira&ccedil;&atilde;o</strong></td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: right"><strong>M&eacute;todo de pagamento</strong></td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: right"><strong>C&oacute;digo de barras</strong></td>
                            <td>
