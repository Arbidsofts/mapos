                        ...
                        <table class="table">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    <tr>
                                        <td colspan="4" class="alert">Voc&ecirc; precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/mapos/emitente">Configurar</a>
                                            <<<</td> </tr> <?php
                                                            } else { ?> <tr>
                                        ...
                                        <td colspan="4" style="width: 100%;">#Venda: <span>
                                                ...
                                                <span style="padding-inline: 1em">Emiss&atilde;o: <?php echo date('d/m/Y'); ?></span>
