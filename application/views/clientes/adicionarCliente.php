    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home">Informa&ccedil;&otilde;es Pessoais</a></li>
                <li><a data-toggle="tab" href="#menu2">Endere&ccedil;o</a></li>
            </ul>
                    ...
                    <div id="home" class="tab-pane fade in active">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <button id="buscar_info_cnpj" class="btn btn-xs" type="button">Buscar Informa&ccedil;&otilde;es (CNPJ)
                                </button>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="nomeCliente" class="control-label">Nome/Raz&atilde;o Social<span
