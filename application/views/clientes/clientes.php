...
<div class="widget-box">
    ...
    <div class="widget-content nopadding tab-content">
        <table id="tabela" class="table table-bordered ">
            ...
            if (!$results) {
                echo '<tr>
                                <td colspan="5">Nenhum Cliente / Fornecedor Cadastrado.</td>
                                </tr>';
            }
            foreach ($results as $r) {
                ...
                if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) {
                    ...
                    echo '<a href="' . base_url() . 'index.php/mine?e=' . $r->email . '&c=' . $r->documento . '" target="new" style="margin-right: 1%" class="btn tip-top" title="&Aacute;rea do cliente"><i class="fas fa-key"></i></a>';
                }
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h5 style="text-align: center">Deseja realmente excluir este cliente e os dados associados a ele (O.S., Vendas, Receitas)?</h5>
        </div>
