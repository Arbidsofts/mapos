    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content">
                ...
                <?php if ($custom_error) { ?>
                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Dados incompletos, verifique os campos com asterisco ou se selecionou corretamente cliente e respons&aacute;vel.</div>
                <?php  } ?>
                ...
                <form action="<?php echo current_url(); ?>" method="post" id="formGarantia">
                    ...
                    <div class="span12">
                        ...
                        <div class="span5">
                            <label for="usuarios_id">Respons&aacute;vel</label>
