...
<div class="span12" style="margin-left: 0;margin-top: 1rem;">
    <form action="<?php echo current_url(); ?>" method="get">
        <div class="span2" style="margin-left: 0">
            <label>Per&iacute;odo <i class="fas fa-calendar-day tip-top"
                              title="Lan&ccedil;amentos com vencimento no per&iacute;odo."></i></label>
            <select id="periodo" name="periodo" class="span12">
                ...
                <option value="mes" <?= $this->input->get('periodo') === 'mes' ? 'selected' : '' ?>>M&ecirc;s</option>
        ...
        <div class="span2">
            <label>Vencimento (at&eacute;) <i class="fas fa-calendar-day tip-top" title="Vencimento (at&eacute;)"></i></label>
    ...
    <div class="widget-box">
      ...
      <span class="icon">
        <i class="fas fa-hand-holding-usd"></i>
            ...
            <h5>Lan&ccedil;amentos Financeiros</h5>
        ...
        <div class="widget-content nopadding tab-content">
            ...
            <table class="table table-bordered " id="divLancamentos">
                ...
                if (!$results) {
                    echo '<tr>
              <td colspan="8" >Nenhum lan&ccedil;amento encontrado.</td>
            </tr>';
                }
...
<div id="modalReceita" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <form id="formReceita" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12 alert alert-info" style="margin-left: 0"> Obrigat&oacute;rio o preenchimento dos campos com asterisco.
            </div>
            <div class="span12" style="margin-left: 0">
...
<div id="modalEditar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <form id="formEditar" action="<?php echo base_url() ?>index.php/financeiro/editar" method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="myModalLabel">Editar Lan&ccedil;amento</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info" style="margin-left: 0"> Obrigat&oacute;rio o preenchimento dos campos com asterisco.
            </div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary">Salvar Altera&ccedil;&otilde;es</button>
        </div>
    </form>
</div>
...
<div id="modalExcluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Excluir Lan&ccedil;amento</h3>
    </div>
    <div class="modal-body">
        <h5 style="text-align: center">Deseja realmente excluir esse lan&ccedil;amento?</h5>
        <input name="id" id="idExcluir" type="hidden" value=""/>
    </div>
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true" id="btnCancelExcluir">Cancelar</button>
        <button class="btn btn-danger" id="btnExcluir">Excluir Lan&ccedil;amento</button>
    </div>
</div>
