        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <div class="buttons">
                    ...
                    <?php if ($editavel) {
                        echo '<a title="Editar O.S." class="btn btn-mini btn-info" href="' . base_url() . 'index.php/os/editar/' . $result->idOs . '"><i class="fas fa-edit"></i> Editar</a>';
                    } ?>
                    <a title="Visualizar O.S." class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/visualizar/<?php echo $result->idOs; ?>"><i class="fas fa-eye"></i> Visualizar</a>
                    <a target="_blank" title="Imprimir O.S." class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/imprimir/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i> Imprimir A4</a>
                    <a target="_blank" title="Imprimir O.S." class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/imprimirTermica/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i> Imprimir N&atilde;o Fiscal</a>
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        ...
                        if (!empty($zapnumber)) {
                            echo '<a title="Enviar Por WhatsApp" class="btn btn-mini btn-success" id="enviarWhatsApp" target="_blank" href="https://wa.me/55' . $zapnumber . '&text=' . $texto_de_notificacao . '" ' . ($zapnumber == '' ? 'disabled' : '') . '><i class="fab fa-whatsapp"></i> WhatsApp</a>';
                        }
                    } ?>
            ...
            <div class="widget-content nopadding tab-content">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        ...
                        <li id="tabServicos"><a href="#tab3" data-toggle="tab">Servi&ccedil;os</a></li>
                        <li id="tabAnexos"><a href="#tab4" data-toggle="tab">Anexos</a></li>
                        <li id="tabAnotacoes"><a href="#tab5" data-toggle="tab">Anota&ccedil;&otilde;es</a></li>
                    </ul>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6">
                                            <label for="tecnico">T&eacute;cnico / Respons&aacute;vel<span class="required">*</span></label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
											...
											<select class="span12" name="status" id="status" value="">
												...
												<option <?php if ($result->status == 'Aguardando Peças') {echo 'selected';} ?> value="Aguardando Peças">Aguardando Pe&ccedil;as</option>
												...
												<option <?php if ($result->status == 'Negociação') {echo 'selected';} ?> value="Negociação">Negocia&ccedil;&atilde;o</option>
												<option <?php if ($result->status == 'Orçamento') {echo 'selected';} ?> value="Orçamento">Or&ccedil;amento</option>
											</select>
                                        </div>
                                        <div class="span3">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <label for="descricaoProduto">
                                            <h4>Descri&ccedil;&atilde;o do Defeito</h4>
                                        </label>
                                    ...
                                    <table width="100%" class="table table-bordered" id="tblProdutos">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="10%">Pre&ccedil;o unit.</th>
                                                <th width="6%">A&ccedil;&otilde;es</th>
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico" method="post">
                                    <div class="span6">
                                        ...
                                        <label for="">Servi&ccedil;o</label>
                                        <input type="text" class="span12" name="servico" id="servico" placeholder="Digite o nome do servi&ccedil;o" />
                                    </div>
                                    <div class="span2">
                                        <label for="">Pre&ccedil;o</label>
                                        <input type="text" placeholder="Pre&ccedil;o" id="preco_servico" name="preco" class="span12 money" data-affixes-stay="true" data-thousands="" data-decimal="." />
                                    </div>
                                    <div class="span2">
                                        <label for="">Quantidade</label>
                                    ...
                                    <table width="100%" class="table table-bordered" id="tblServicos">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($servicos as $s) {
                                                ...
                                                echo '<td><div align="center"><span idAcao="' . $s->idServicos_os . '" title="Excluir Servi&ccedil;o" class="btn btn-danger servico"><i class="fas fa-trash-alt"></i></span></div></td>';
                        ...
                        <div class="tab-pane" id="tab5">
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                ...
                                <div class="span12" id="divAnotacoes" style="margin-left: 0">
                                    ...
                                    <a href="#modal-anotacao" id="btn-anotacao" role="button" data-toggle="modal" class="btn btn-success"><i class="fas fa-plus"></i> Adicionar anota&ccedil;&atilde;o</a>
                                    <hr>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($anotacoes as $a) {
                                                ...
                                                echo '<td><span idAcao="' . $a->idAnotacoes . '" title="Excluir Anota&ccedil;&atilde;o" class="btn btn-danger anotacao"><i class="fas fa-trash-alt"></i></span></td>';
                                                echo '</tr>';
                                            }
                                            if (!$anotacoes) {
                                                echo '<tr><td colspan="2">Nenhuma anota&ccedil;&atilde;o cadastrada.</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
...
<div id="modal-anotacao" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="#" method="POST" id="formAnotacao">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="myModalLabel">Adicionar Anota&ccedil;&atilde;o</h3>
        </div>
        <div class="modal-body">
            <div class="span12" id="divFormAnotacoes" style="margin-left: 0"></div>
            <div class="span12" style="margin-left: 0">
                <label for="anotacao">Anota&ccedil;&atilde;o</label>
...
<div id="modal-faturar" class="modal hide fade widget_box_vizualizar4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        <div class="modal_header_anexos">
            ...
            <h3 id="myModalLabel">Faturar O.S.</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info" style="margin-left: 0"> Obrigat&oacute;rio o preenchimento dos campos com asterisco.</div>
            <div class="span12" style="margin-left: 0">
                <label for="descricao">Descri&ccedil;&atilde;o</label>
                <input class="span12" id="descricao" type="text" name="descricao" value="Fatura de O.S. Nº: <?php echo $result->idOs; ?> " />
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4">
                    ...
                    <input style="width: 4em;" id="num2" type="text" placeholder="%" onblur="calcular()" maxlength="6" size="2" />
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
                ...
                <div id="divRecebimento" class="span8" style=" display: none">
                    ...
                    <div class="span6">
                        ...
                        <select name="formaPgto" id="formaPgto" class="span12">
                            ...
                            <option value="Cartão de Crédito">Cart&atilde;o de Cr&eacute;dito</option>
                            <option value="Débito">D&eacute;bito</option>
                            <option value="Boleto">Boleto</option>
                            <option value="Depósito">Dep&oacute;sito</option>
            ...
            submitHandler: function(form) {
                ...
                if (qtdTotalProdutosServicos <= 0) {
                    Swal.fire({
                        type: "error",
                        title: "Atenção",
                        text: "Não é possível faturar uma O.S. sem serviços e/ou produtos."
                    });
                        ...
                        success: function(data) {
                            if (data.result == true) {
                                ...
                                Swal.fire({
                                    type: "error",
                                    title: "Atenção",
                                    text: "Ocorreu um erro ao tentar faturar O.S."
                                });
