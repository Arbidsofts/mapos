                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    <tr>
                                        <td colspan="5" class="alert">Voc&ecirc; precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/mapos/emitente">Configurar</a>
                                            <<<</td> </tr> <?php } else { ?> <tr>
                                        ...
                                        <td colspan="5" style="text-align: center"> <span style="font-size: 20px; ">
                                            ...
                                            <span style="font-size: 10px; ">CNPJ: <?php echo $emitente[0]->cnpj; ?> </br>
                                                <?php echo $emitente[0]->rua . ', ' . $emitente[0]->numero . ' ' . $emitente[0]->bairro . ' -  ' . $emitente[0]->cidade . ' - ' . $emitente[0]->uf; ?> </span> </br> <span>Telefone: <?php echo $emitente[0]->telefone; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%; font-size: 10px;"><b>N° O.S.:</b> <span><?php echo $result->idOs ?></span><span style="padding-left: 5%;"><b>Emiss&atilde;o:</b> <?php echo date('d/m/Y') ?></span></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
