...
<head>
    <title><?php echo $this->config->item('app_name') ?>_<?php echo $result->idOs ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                ...
                <div class="invoice-content">
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        <td colspan="3" class="alert">Voc&ecirc; precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/mapos/emitente">Configurar</a>
                                                    ...
                                                    <span class="icon">
                                                        ...
                                                        <span class="icon">
                                                            ...
                                                            <span class="icon">
                                                                ...
                                                                Respons&aacute;vel: <?php echo $result->nome ?>
                                        <td style="width: 18%; text-align: center"><b>N° O.S.:</b> <span><?php echo $result->idOs ?></span></br> </br> <span>Emiss&atilde;o: <?php echo date('d/m/Y') ?></span></td>
                                        </span>
                                        </td>
                                    </tr>
                                <?php } ?>
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        if ($totalProdutos != 0 || $totalServico != 0) {
                            echo "<h4 style='text-align: right'> Valor Total da O.S.: R$" . number_format($totalProdutos + $totalServico, 2, ',', '.') . "</h4>";
                        }
                        ?>
                        ...
                        <table class="table table-bordered table-condensed">
                            <tbody>
                                <tr>
                                    ...
                                    <td>Assinatura do T&eacute;cnico Respons&aacute;vel
                                        <hr>
                                    </td>
                                </tr>
                            </tbody>
