...
<div class="row-fluid" style="margin-top: 0">
    ...
    echo '<a title="Editar O.S." class="btn btn-mini btn-info" href="' . base_url() . 'index.php/os/editar/' . $result->idOs . '"><i class="fas fa-edit"></i> Editar</a>';
                    ...
                    <a target="_blank" title="Imprimir O.S." class="btn btn-mini btn-inverse"
                    ...
                    <a target="_blank" title="Imprimir O.S." class="btn btn-mini btn-inverse"
                       href="<?php echo site_url() ?>/os/imprimirTermica/<?php echo $result->idOs; ?>"><i
                                class="fas fa-print"></i> Imprimir N&atilde;o Fiscal</a>
    ...
    if (!empty($zapnumber)) {
        echo '<a title="Enviar por WhatsApp" class="btn btn-mini btn-success" id="enviarWhatsApp" target="_blank" href="https://wa.me/55' . $zapnumber . '&text=' . $texto_de_notificacao . '"><i class="fab fa-whatsapp"></i> WhatsApp</a>';
    }
} ?>
                    ...
                    <div class="invoice-head" style="margin-bottom: 0">
                        ...
                        <table class="table table-condensed">
                            ...
                            <?php if ($emitente == null) { ?>
                                <tr>
                                    <td colspan="3" class="alert">Voc&ecirc; precisa configurar os dados do emitente. >>><a
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center"><b>N° O.S.:</b>
                                        <span><?php echo $result->idOs ?></span></br> </br>
                                        <span>Emiss&atilde;o: <?php echo date('d/m/Y') ?></span></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 50%; padding-left: 0">
                                    <ul>
                                        <li>
                                                <span>
                                                    <h5><b>RESPONS&Aacute;VEL</b></h5>
                                                </span>
                                            <span><?php echo $result->nome ?></span> <br/>
                                            <span>Contato: <?php echo $result->telefone_usuario ?></span><br/>
                                            <span>E-mail: <?php echo $result->email_usuario ?></span>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
