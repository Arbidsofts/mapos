...
<div class="span12" style="margin-left: 0">
    <form method="get" action="<?php echo base_url(); ?>index.php/os/gerenciar">
        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aOs')) { ?>
            <div class="span3">
                <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="btn btn-success span12"><i class="fas fa-plus"></i> Adicionar O.S.</a>
            </div>
        <?php
        } ?>
        <div class="span3">
...
<div class="widget-box">
    <div class="widget-title">
        ...
        <h5>Ordens de Servi&ccedil;o</h5>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered ">
                ...
                <tbody>
                    ...
                    if (!$results) {
                        echo '<tr>
                                    <td colspan="10">Nenhuma O.S. cadastrada.</td>
                                  </tr>';
                    }
                    ...
                    foreach ($results as $r) {
                       ...
                       switch ($r->status) {
							...
							case 'Finalizado':
								$cor = '#256';
								break;
							case 'Negocia&ccedil;&atilde;o':
								$cor = '#AEB404';
								break;
							case 'Or&ccedil;amento':
								$cor = '#CDB380';
								break;
							default:
								$cor = '#E0E4CC';
                        ...
                        if ($editavel) {
                            echo '<a style="margin-right: 1%" href="' . base_url() . 'index.php/os/editar/' . $r->idOs . '" class="btn btn-info tip-top" title="Editar O.S."><i class="fas fa-edit"></i></a>';
                        }
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'dOs') && $editavel) {
                            echo '<a href="#modal-excluir" role="button" data-toggle="modal" os="' . $r->idOs . '" class="btn btn-danger tip-top" title="Excluir O.S."><i class="fas fa-trash-alt"></i></a>  ';
                        }
                        echo '</td>';
                        echo '</tr>';
                    } ?>
