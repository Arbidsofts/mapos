...
class Mapos extends MY_Controller
{
    ...
    public function cadastrarEmitente()
    {
        ...
        $this->form_validation->set_rules('nome', 'Raz&atilde;o Social', 'required|trim');
        ...
        $this->form_validation->set_rules('numero', 'N&uacute;mero', 'required|trim');
    ...
    public function configurar()
    {
        ...
        $this->form_validation->set_rules('per_page', 'Registros por p&aacute;gina', 'required|numeric|trim');
        $this->form_validation->set_rules('app_theme', 'Tema do Sistema', 'required|trim');
        $this->form_validation->set_rules('os_notification', 'Notifica&ccedil;&atilde;o de O.S.', 'required|trim');
        $this->form_validation->set_rules('control_estoque', 'Controle de Estoque', 'required|trim');
        $this->form_validation->set_rules('notifica_whats', 'Notifica&ccedil;&atilde;o Whatsapp', 'required|trim');
        $this->form_validation->set_rules('control_baixa', 'Controle de Baixa', 'required|trim');
        $this->form_validation->set_rules('control_editos', 'Controle de Edi&ccedil;&atilde;o de O.S.', 'required|trim');
        $this->form_validation->set_rules('control_datatable', 'Controle de Visualiza&ccedil;&atilde;o em DataTables', 'required|trim');
        $this->form_validation->set_rules('os_status_list[]', 'Controle de visualiza&ccedil;&atilde;o de O.S.', 'required|trim', ['required' => 'Selecione ao menos uma das op&ccedil;&otilde;es.']);
    ...
    public function calendario()
    {
        ...
        $events = array_map(function ($os) {
            ...
            return [
                'title' => "O.S.: {$os->idOs}, Cliente: {$os->nomeCliente}",
                'start' => $os->dataFinal,
                'end' => $os->dataFinal,
                'color' => $cor,
                'extendedProps' => [
                    ...
                    'status' => '<b>Status da O.S.:</b> ' . $os->status,
