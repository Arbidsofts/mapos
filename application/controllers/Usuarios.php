...
class Usuarios extends MY_Controller
{
    ...
    public function editar()
    {
        ...
        $this->form_validation->set_rules('numero', 'N&uacute;mero', 'trim');
        ...
        $this->form_validation->set_rules('situacao', 'Situa&ccedil;&atilde;o', 'trim|required');
        $this->form_validation->set_rules('permissoes_id', 'Permiss&atilde;o', 'trim|required');
