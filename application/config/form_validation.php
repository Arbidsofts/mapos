...
$config = [
    'clientes' => [
        ...
        [
            ...
            'errors' => [
                'verific_cpf_cnpj' => "O campo %s n&atilde;o &eacute; um CPF ou CNPJ v&aacute;lido."
            ],
        ],
        [
            'field' => 'telefone',
    ...
    'produtos' => [
        ...
        [
            'field' => 'precoCompra',
            'label' => 'Pre&ccedil;o de Compra',
            'rules' => 'required|trim',
        ],
        [
            'field' => 'precoVenda',
            'label' => 'Pre&ccedil;o de Venda',
            'rules' => 'required|trim',
        ],
        [
            'field' => 'estoque',
    ...
    'usuarios' => [
        ...
        [
            ...
            'errors' => [
                'verific_cpf_cnpj' => "O campo %s n&atilde;o &eacute; um CPF v&aacute;lido."
            ],
        ],
        [
            'field' => 'rua',
    ...
    'os' => [
        ...
        [
            ...
            'rules' => 'trim|numeric',
            'errors' => [
                'numeric' => 'Por favor digite apenas n&uacute;mero.'
            ],
        ],
        [
            'field' => 'termoGarantia',
    ...
    'vendas' => [
        ...
        [
            'field' => 'observacoes',
            'label' => 'Observa&ccedil;&otilde;es',
            'rules' => 'trim',
        ],
        [
            'field' => 'clientes_id',
