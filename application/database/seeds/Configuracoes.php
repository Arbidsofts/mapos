    ...
    public function run()
    {
        ...
        $configs = [
            ...
            [
                ...
                'valor' => 'Prezado(a), {CLIENTE_NOME} a O.S. de nº {NUMERO_OS} teve o status alterado para :{STATUS_OS} segue a descrição {DESCRI_PRODUTOS} com valor total de {VALOR_OS}!
